...
<body>
	...
	<div class=m1>
			...
			<div class=m2>
				<div id='error'></div>
			<form method="POST"  onsubmit="return validation(this)" name="frm" action="includes/signup_o.inc.php" >
				...
				<label for="username">Username :</label><input type="text" name="uid" placeholder="Enter your username" id="user" autocomplete="off" >
